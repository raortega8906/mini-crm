                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.companies.update', $company) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="website" class="form-control" type="url" name="website" value="{{ $company->website }}">
                            </div>
                            <div class="form-group">
                                <label for="logo">{{ _('Logo') }}</label>
                                <input id="logo" class="form-control" type="file" name="logo" value="{{ $company->logo }}">
                            </div>
                            <button type="submit" class="btn btn-sm btn-success">{{ _('Actualizar la empresa') }}</button>
                        </form>             
                    </div>
                </div>
            </div>
